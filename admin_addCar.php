            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="nb_door" required>
                        <option selected disabled>Veuillez choisir un nombre de porte</option>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="gearbox" required>
                        <option selected disabled>Veuillez choisir la boite de vitesse</option>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="fuel" required>
                        <option selected disabled>Veuillez choisir un carburant</option>
